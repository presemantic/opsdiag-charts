...
{{- define "opsdiag-app-front.serviceAccountName" -}}
...
{{- define "opsdiag-app-front.selectorLabels" -}}
{{ include "common.labels.matchLabels" (dict "customLabels" .Values.podLabels "context" .) }}
app.kubernetes.io/component: {{ .Values.component | quote }}
{{- end -}}

{{- define "opsdiag-app-front.podLabels" -}}
...
{{- define "opsdiag-app-front.resources" -}}
{{- if .Values.resources -}}
...
{{- define "opsdiag-app-front.affinity" -}}
{{- if .Values.affinity -}}
