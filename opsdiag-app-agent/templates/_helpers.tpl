...
{{- define "opsdiag-app-agent.serviceAccountName" -}}
...
{{- define "opsdiag-app-agent.resources" -}}
{{- if .Values.resources -}}
...
{{- define "opsdiag-app-agent.affinity" -}}
{{- if .Values.affinity -}}
