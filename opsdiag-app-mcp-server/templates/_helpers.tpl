...
{{- define "opsdiag-app-mcp-server.serviceAccountName" -}}
...
{{- define "opsdiag-app-mcp-server.resources" -}}
{{- if .Values.resources -}}
...
{{- define "opsdiag-app-mcp-server.affinity" -}}
{{- if .Values.affinity -}}
