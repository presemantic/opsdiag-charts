...
{{- define "opsdiag-app-mcp-proxy.serviceAccountName" -}}
...
{{- define "opsdiag-app-mcp-proxy.resources" -}}
{{- if .Values.resources -}}
...
{{- define "opsdiag-app-mcp-proxy.affinity" -}}
{{- if .Values.affinity -}}
